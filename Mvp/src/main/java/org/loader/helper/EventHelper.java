...
public class EventHelper {
    ...
    public static void OnNavigationItemSelectedListener(NavigationView.OnNavigationItemSelectedListener li, NavigationView... view) {
        if (view == null || view.length == 0) return;
        for (NavigationView v : view)
            v.setNavigationItemSelectedListener((NavigationView.OnNavigationItemSelectedListener) li);
    }
}
