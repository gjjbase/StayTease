...
public class LrcView extends View {
    ...
    private void inflateAttributes(AttributeSet attrs) {
        ...
        TypedArray ta = getContext().obtainStyledAttributes(attrs,
                gjj.staytease.com.R.styleable.Lrc);
        mTextSize = ta.getDimension(gjj.staytease.com.R.styleable.Lrc_textSize, 100.0f);
        mRows = ta.getInteger(gjj.staytease.com.R.styleable.Lrc_rows, 5);
        mDividerHeight = ta.getDimension(gjj.staytease.com.R.styleable.Lrc_dividerHeight, 0.0f);

        int normalTextColor = ta.getColor(gjj.staytease.com.R.styleable.Lrc_normalTextColor,
                0xffffffff);
        int currentTextColor = ta.getColor(gjj.staytease.com.R.styleable.Lrc_currentTextColor,
                0xff00ffde);
        ta.recycle();
        // </end>
