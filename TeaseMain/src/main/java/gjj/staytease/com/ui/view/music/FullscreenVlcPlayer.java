...
import gjj.staytease.com.util.SystemUiHider;
...
public class FullscreenVlcPlayer extends Activity implements SurfaceHolder.Callback, IVideoPlayer {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edt.setText(urlToStream);
        btn=(Button)findViewById(R.id.text);
        btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                playMovie(edt.getText().toString().trim());
            }
        });
        // OVERLAY / CONTROLS
    ...
    private void setupControls() {
        ...
        vlcButtonPlayPause.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (libvlc.isPlaying()) {
                    libvlc.pause();
                    vlcButtonPlayPause.setImageDrawable(getResources().getDrawable(android.R.drawable.ic_media_play));
                } else {
                    libvlc.play();
                    vlcButtonPlayPause.setImageDrawable(getResources().getDrawable(android.R.drawable.ic_media_pause));
                }
            }
        });
    ...
    public void playMovie(String urlToStream) {
